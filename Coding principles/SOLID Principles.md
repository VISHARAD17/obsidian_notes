>[!info]  These principles  are guidelines to when building software that is easier to maintain and scale. SOLID principle provides a blueprint for writing code that is easy to adjust, extend and maintain over time.

Principles:
- Single responsibility
## S - Single Responsibility

>[!info] A Single class should only have one responsibility
...
> [!note] Client should not be dependent on the methods that they do not use
