> Explains the tradeoffs when designing distributed system. When designing a system it is impossible to guaranty all three behaviours. 
> We have to choose any two of them depending on our requirements.
